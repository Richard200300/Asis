  ...
  return (
    <section className="mt-8 flex items-center border-y border-[#000000]">
      ...
      <div
        ...
        className="flex h-10 cursor-pointer items-center justify-center gap-1 border-r border-[#000000] px-5 uppercase text-asisDark max-md:px-3"
      >
      ...
      {/* Sort by */}
      <div className="flex h-10 cursor-pointer items-center justify-center gap-1 border-l border-[#000000] px-5 uppercase text-asisDark">
